...
Usage:
    ...
    python query_domain_index.py --top-domains 50

    # Top TLDs
    python query_domain_index.py --top-tlds 20

    # Filter by TLD
    python query_domain_index.py --tld .edu
    python query_domain_index.py --tld .gov

    # Filter by domain pattern (substring match)
    python query_domain_index.py --domain-contains wiki

    # Filter by URL path pattern
    python query_domain_index.py --path-contains /wiki/BMW
    python query_domain_index.py --path-contains /wiki/Honda

    # Custom SQL query
    python query_domain_index.py --sql "SELECT tld, SUM(token_count) as tokens FROM idx GROUP BY tld ORDER BY tokens DESC LIMIT 10"
"""
