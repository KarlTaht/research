...
Usage:
    # Full run (all shards)
    python -m common.cli._internal.build_domain_index

    # Incremental runs
    python -m common.cli._internal.build_domain_index --start-shard 0 --num-shards 100
    python -m common.cli._internal.build_domain_index --start-shard 100 --num-shards 100

    # Check progress
    python -m common.cli._internal.build_domain_index --status
"""
...
# Paths
FINEWEB_DIR = get_datasets_dir() / "HuggingFaceFW/fineweb/sample-100BT/train"
OUTPUT_PATH = get_datasets_dir() / "HuggingFaceFW/fineweb/domain_index.parquet"
