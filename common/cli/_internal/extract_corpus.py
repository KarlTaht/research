...
Usage:
    ...
    python -m common.cli._internal.extract_corpus

    # Extract specific corpus
    python -m common.cli._internal.extract_corpus --corpus automotive
    python -m common.cli._internal.extract_corpus --corpus food

    # Custom target size (in tokens, default 125M = ~500MB)
    python -m common.cli._internal.extract_corpus --target-tokens 50000000

    # Preview mode (show stats without extracting)
    python -m common.cli._internal.extract_corpus --preview
"""
