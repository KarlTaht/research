...
Examples:
  ...
  python -m common.cli._internal.query_experiments --list

  # Show summary of all experiments
  python -m common.cli._internal.query_experiments --summary

  # Get top 5 experiments by lowest perplexity
  python -m common.cli._internal.query_experiments --best perplexity --minimize --top 5

  # Get top 3 experiments by highest BLEU score
  python -m common.cli._internal.query_experiments --best bleu_score --no-minimize --top 3

  # Custom SQL query
  python -m common.cli._internal.query_experiments --sql "SELECT * FROM experiments WHERE epoch > 5"

  # Compare specific experiments
  python -m common.cli._internal.query_experiments --compare exp_001 exp_002 exp_003

  # Load single experiment
  python -m common.cli._internal.query_experiments --load exp_001
        """,
    )
