...
**Files to create:**
```
projects/research_manager_agent/
├── pyproject.toml
├── src/
│   └── research_manager/
│       ├── __init__.py
...
**File:** `src/research_manager/schemas.py`
...
**File:** `src/research_manager/indexer.py`
...
**File:** `src/research_manager/main.py`
...
**File:** `src/research_manager/tools/explore.py`
...
**File:** `src/research_manager/tools/projects.py`
...
**File:** `src/research_manager/tools/scripts.py`
...
**File:** `src/research_manager/tools/configs.py`
...
**File:** `src/research_manager/tools/experiments.py`
...
**File:** `src/research_manager/tools/logs.py`
...
**File:** `src/research_manager/tools/checkpoints.py`
...
**File:** `src/research_manager/tools/compare.py`
...
**File:** `src/research_manager/tools/commands.py`
...
**File:** `src/research_manager/tools/cleanup.py`
...
**File:** `src/research_manager/tools/errors.py`
...
**File:** `src/research_manager/safety/hooks.py`
...
**File:** `src/research_manager/safety/audit.py`
...
**File:** `src/research_manager/ui/terminal.py`
...
**File:** `src/research_manager/memory/session.py`
...
```json
{
  "mcpServers": {
    "research-manager": {
      "command": "python",
      "args": ["-m", "research_manager.server"],
