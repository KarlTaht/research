...
from research_manager.tools import ToolRegistry, ToolSpec, ToolCategory, tool
from research_manager.tools.registry import get_global_registry, reset_global_registry
