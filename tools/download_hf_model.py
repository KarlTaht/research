...
Examples:
  ...
  python tools/download_hf_model.py --repo-id openai/clip-vit-base-patch32 --output /path/to/models

  # Download specific revision (branch/tag/commit)
  python tools/download_hf_model.py --repo-id facebook/opt-1.3b --revision main
        """,
    )
