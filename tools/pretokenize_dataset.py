...
Usage:
    ...
    python tools/pretokenize_dataset.py --jsonl data/corpus_automotive/train.jsonl --tokenizer combined_bpe_32768 --max-length 1024

    # Pre-tokenize validation split too
    python tools/pretokenize_dataset.py --jsonl data/corpus_automotive/train.jsonl --val-jsonl data/corpus_automotive/val.jsonl --tokenizer combined_bpe_32768
"""
