...
Examples:
    ...
    python tools/analyze_tokens.py --jsonl projects/continual_learning/data/corpus_automotive/train.jsonl
    ...
    python tools/analyze_tokens.py --jsonl data/corpus_automotive/train.jsonl --train-tokenizer 16384

    # Train a tokenizer from multiple JSONL files (combined corpora)
    python tools/analyze_tokens.py --jsonl data/corpus_automotive/train.jsonl data/corpus_food/train.jsonl --train-tokenizer 32768
...
from common.data.token_analyzer import TokenAnalyzer, train_custom_tokenizer, train_custom_tokenizer_from_file
